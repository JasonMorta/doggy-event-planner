        ...
        {loading ? (
          ...
          <DialogContent className="newEvent">
            ...
            >
              ...
              >
                <MenuItem type="text" value={"Mini"}>
                  Mini
                </MenuItem>
                <MenuItem type="text" value={"Small"}>
                  Small
                </MenuItem>
                <MenuItem type="text" value={"Medium"}>
                  Medium
                </MenuItem>
                <MenuItem type="text" value={"Large"}>
                  Large
                </MenuItem>
                <MenuItem type="text" value={"All sizes"}>
                  All sizes
                </MenuItem>
              </Select>
            </FormControl>
